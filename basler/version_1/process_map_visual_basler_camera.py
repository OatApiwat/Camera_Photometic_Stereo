...
class PhotometricStereo:
    #def __init__(self, pgrads, qgrads):
...
if __name__ == "__main__":
   for index in range(1, 5):
        folder_number = index
        input_folder = f"/home/mic/Camera_project/basler/version_1/Picture_{folder_number}"
        output_folder = f"/home/mic/Camera_project/basler/version_1/Result_{folder_number}"
