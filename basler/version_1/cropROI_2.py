    ...
    def process_images(self):
        ...
        for image_file in image_files:
            ...
            for i, (x, y, r) in enumerate(self.circles, start=1):
                ...
                output_cropped_filename = f"{base_name}_{folder_number}_3_roi{i}{ext}"
...
if __name__ == "__main__":
    ...
    for index in range(1, 5):
        folder_number = index
        input_folder = f"/home/mic/Camera_project/basler/version_1/Result_{folder_number}"
        output_folder = f"/home/mic/Camera_project/basler/version_1/ROI_{folder_number}"
